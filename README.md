  ...
  <body>
    ...
    <header class="header">
      <nav class="nav bd_grid">
        <div>
          <a href="#" class="nav_logo">CodeWithHarini</a>
        </div>
    ...
    <main class="main">
      ...
      <section class="home bd_grid" id="home">
        <div class="home_data" data-aos="fade-down">
          <h1 class="home_title">
            Hi, <br />I'm <span class="home_title-color">Harini M M</span
            ><br />
          </h1>
        ...
        <div class="about_container bd_grid">
          ...
          <div>
            ...
            <p class="about_text" data-aos="fade-down" data-aos-delay="450">
             I am a student of KIT-Kalaignarkarunanudhi Institute of Techology in coimbatore.
            </p>
          </div>
        </div>
      </section>
        ...
        <div class="skills_container bd_grid">
          <div>
            ...
            <p class="skills_text" data-aos="fade-down" data-aos-delay="350">
             NPTEL-Problem solving through programming in C(Elite).
             Edukera-Webinar
             Floxus-Intenship
            </p>
            <!-- SKILLS HTML -->
            <div class="skills_data" data-aos="fade-right">
              ...
              <div><span class="skill_percentage">90%</span></div>
            ...
            <div class="skills_data" data-aos="fade-right" data-aos-delay="250">
              <div class="skills_name">
                ...
                <span class="skill_name">C\C++</span>
              </div>
